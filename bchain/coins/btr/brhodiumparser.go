...
func init() {
	...
	MainNetParams.Bech32HRPSegwit = "btr"
	TestNetParams.Bech32HRPSegwit = "tbtr"
}

// BRhodiumParser handle
type BRhodiumParser struct {
	*btc.BitcoinParser
}

// NewBRhodiumParser returns new BRhodiumParser instance
func NewBRhodiumParser(params *chaincfg.Params, c *btc.Configuration) *BRhodiumParser {
	return &BRhodiumParser{BitcoinParser: btc.NewBitcoinParser(params, c)}
}
...
func (p *BRhodiumParser) ParseBlock(b []byte) (*bchain.Block, error) {
	r := bytes.NewReader(b)
